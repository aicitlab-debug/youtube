      ...
      <div className="flex items-center gap-1 md:gap-4 flex-shrink-0">
        ...
        <a href="/" className="flex items-center gap-1">
          <div className="bg-primary rounded-lg p-1.5">
            <svg viewBox="0 0 24 24" className="h-4 w-4 md:h-5 md:w-5 text-primary-foreground fill-current">
              <path d="M10 15l5.19-3L10 9v6m11.56-7.83c.13.47.22 1.1.28 1.9.07.8.1 1.49.1 2.09L22 12c0 2.19-.16 3.8-.44 4.83-.25.9-.83 1.48-1.73 1.73-.47.13-1.33.22-2.65.28-1.3.07-2.49.1-3.59.1L12 19c-4.19 0-6.8-.16-7.83-.44-.9-.25-1.48-.83-1.73-1.73-.13-.47-.22-1.1-.28-1.9-.07-.8-.1-1.49-.1-2.09L2 12c0-2.19.16-3.8.44-4.83.25-.9.83-1.48 1.73-1.73.47-.13 1.33-.22 2.65-.28 1.3-.07 2.49-.1 3.59-.1L12 5c4.19 0 6.8.16 7.83.44.9.25 1.48.83 1.73 1.73z"/>
            </svg>
          </div>
          <span className="text-base md:text-xl font-semibold tracking-tight hidden sm:inline">FynzaTube</span>
        </a>
      </div>

      {/* Center section - Search */}
      <form onSubmit={handleSubmit} className="flex items-center flex-1 max-w-2xl mx-2 md:mx-4 min-w-0">
        <div className="flex flex-1 relative min-w-0">
          <input
            ...
            className="search-input flex-1 min-w-0 text-sm pr-8"
          />
          {searchQuery && (
            <button
              type="button"
        ...
        <Button variant="ghost" size="icon" className="rounded-full ml-1 hidden sm:flex flex-shrink-0">
